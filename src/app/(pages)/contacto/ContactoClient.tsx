...
import { faqs } from '@/data/contacto';
import type { ContactoInfo } from '@/lib/textos';
...
export default function ContactoClient({ bannerImagen, bannerTitulo, bannerSubtitulo, contactoInfo }: ContactoClientProps) {
  ...
  return (
    <>
      ...
      <section className="relative h-[280px] md:h-[340px] flex items-center justify-center overflow-hidden -mt-16 sm:-mt-[88px] md:-mt-[120px] lg:-mt-[136px]">
        <img src={bannerImagen} alt="Contacto" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-dark/70" />
        <div className="relative text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">{bannerTitulo}</h1>
