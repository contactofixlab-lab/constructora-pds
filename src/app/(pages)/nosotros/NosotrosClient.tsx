  ...
  return (
    <>
      ...
      <section className="relative h-[340px] md:h-[420px] flex items-center justify-center overflow-hidden -mt-16 sm:-mt-[88px] md:-mt-[120px] lg:-mt-[136px]">
        <img src={bannerImagen} alt="Nuestro equipo" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <section className="py-section bg-background-surface">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {directivaImagen ? (
            <div className="rounded-card overflow-hidden h-72 mb-10">
              <img src={directivaImagen} alt="Directiva de socios" className="w-full h-full object-cover" />
            </div>
          ) : (
